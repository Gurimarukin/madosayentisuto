...
const messageEditCommand = Command.messageGuild({ name: Keys.editMessage, isAdmin: true })

const messageDeleteCommand = Command.messageGuild({ name: Keys.deleteMessage, isAdmin: true })
