...
// import { Dict, Either, Future, Maybe, NonEmptyArray } from '../../utils/fp'
...
// const images: Dict<string, string> = {
//   mefian:
...
//   return (message: Message, command: Commands) =>
//     (guild: Guild): Future<unknown> => {
//       switch (command._tag) {
//         // calls
//         case 'CallsInit':
//           return pipe(
...
//         // defaultRole
//         case 'DefaultRoleGet':
//           return Future.sequenceArray<unknown>([
//             deleteMessage(message),
//             pipe(
...
//           return pipe(
//             deleteMessage(message),
//             Future.chain(() => discord.fetchRole(guild, command.role)),
//             Future.chain(
//               Maybe.fold(
//                 () =>
...
//     channel: TSnowflake,
//     role: TSnowflake,
//   ): Future<ValidatedNea<string, Tuple<TextChannel, Role>>> {
//     return pipe(
