...
// import { io, number, ord, random } from 'fp-ts'
...
//       ),
//       // set default role
//       Future.chain(() => guildStateService.getDefaultRole(member.guild)),
//       Future.chain(
//         Maybe.fold(
//           () => Future.unit,
//           role =>
...
//       IO.chain(() => randomLeaveMessage(member)),
//       Future.fromIOEither,
//       Future.chain(msg =>
//         pipe(
...
// const leaveMessages: NonEmptyArray<(member: string) => string> = [
...
//   return pipe(
//     random.randomElem(leaveMessages),
//     io.map(msg => Either.right(msg(`**${member.user.tag}**`))),
//   )
// }
